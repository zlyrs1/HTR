...
class Param:
    def __init__(self):
        ...
        project_prefix = Path('/home/code') # /home/code   /home/zhouly/code
        self.parser.add_argument('--project_prefix', type=str, default=str(project_prefix), help="project path")

        self.parser.add_argument('--run_type', type=str, default="train", help="[collect, train, eval]")
        self.parser.add_argument('--policy_type', type=str, default="cma", help="[seq2seq, cma]")
        self.parser.add_argument('--collect_type', type=str, default="TF", help="[TF, dagger, SF]")
        self.parser.add_argument('--name', type=str, default='AirVLN-cma', help='experiment name')
        ...
        self.parser.add_argument('--Image_Height_RGB', type=int, default=448)
        self.parser.add_argument('--Image_Width_RGB', type=int, default=448)
        ...
        self.parser.add_argument('--dagger_update_size', type=int, default=5000)
        ...
        self.parser.add_argument('--subtask_selection_mode', type=str, default='hard', choices=['hard', 'soft', 'topk'])
        self.parser.add_argument('--subtask_topk', type=int, default=2)
        ...
        self.parser.add_argument("--simulator_tool_port", type=int, default=55000, help="simulator_tool port")
